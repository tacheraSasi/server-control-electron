const Switch = ({ type,checked, onChange }) => (
    <label htmlFor={`switch-${type}`} className={`relative inline-flex items-center cursor-pointer ${checked ? "bg-blue-600" : "bg-neutral-400"} rounded-full w-14 h-8 transition-colors duration-300`}>
